...
class SpotKalmanFilter:
    """Filtr Kalmana dla pozycji 2D i prędkości punktu."""
...
def smooth_xy_sequence(
    ...
    """Wygładza sekwencję XY i zwraca informację, czy punkt był predykowany."""
    kf = SpotKalmanFilter(
        dt=1.0,
        process_noise=process_noise,
        measurement_noise=measurement_noise,
    )
    return [kf.update(item) for item in points]

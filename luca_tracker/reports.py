"""Warstwa kompatybilności dla legacy importów z `reports`."""
...
warnings.warn(
    (
        "`luca_tracker.reports` is deprecated and will be removed after "
        f"{LEGACY_REMOVAL_TARGET}. Migration path: use `luca_reporting.reports`. "
...
from luca_reporting.reports import *  # noqa: F401,F403

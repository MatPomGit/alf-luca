"""Warstwa kompatybilności dla legacy importów z `ros2_node`."""
...
warnings.warn(
    (
        "`luca_tracker.ros2_node` is deprecated and will be removed after "
        f"{LEGACY_REMOVAL_TARGET}. Migration path: use `luca_publishing.ros2_node`. "
...
from luca_publishing.ros2_node import *  # noqa: F401,F403

"""Warstwa kompatybilności dla legacy importów z `detector_registry`."""
...
warnings.warn(
    (
        "`luca_tracker.detector_registry` is deprecated and will be removed after "
        f"{LEGACY_REMOVAL_TARGET}. Migration path: use `luca_processing.detector_registry`. "

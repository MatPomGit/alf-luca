"""Warstwa kompatybilności dla legacy importów z `types`."""
...
warnings.warn(
    (
        "`luca_tracker.types` is deprecated and will be removed after "
        f"{LEGACY_REMOVAL_TARGET}. Migration path: use `luca_types.types`. "
...
from luca_types.types import *  # noqa: F401,F403

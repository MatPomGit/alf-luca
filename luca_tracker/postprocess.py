"""Warstwa kompatybilności dla legacy importów z `postprocess`."""
...
warnings.warn(
    (
        "`luca_tracker.postprocess` is deprecated and will be removed after "
        f"{LEGACY_REMOVAL_TARGET}. Migration path: use `luca_processing.postprocess`. "

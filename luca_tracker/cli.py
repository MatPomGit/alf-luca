...
def build_parser():
    ...
    p_track.add_argument("--min_persistence_frames", type=int, default=1, help="Liczba kolejnych klatek wymaganych do potwierdzenia detekcji (1 = zgodność wsteczna)")
    p_track.add_argument("--persistence_radius_px", type=float, default=12.0, help="Maksymalny skok centroidu [px] między klatkami przy filtrze trwałości")
    ...
    p_ros2.add_argument("--min_persistence_frames", type=int, default=1, help="Liczba kolejnych klatek wymaganych do potwierdzenia detekcji (1 = zgodność wsteczna)")
    p_ros2.add_argument("--persistence_radius_px", type=float, default=12.0, help="Maksymalny skok centroidu [px] między klatkami przy filtrze trwałości")
